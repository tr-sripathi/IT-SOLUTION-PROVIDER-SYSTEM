...
namespace ITSolutionProviderSystem.Controllers
{
    ...
    public class ITSolutionProviderController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AddIssue(IssueDetail IssueDetail)
        {
            int count = 0;
            string Out = "";
            using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(Connection))
            {
                MySql.Data.MySqlClient.MySqlCommand cmd1 = new MySql.Data.MySqlClient.MySqlCommand("insert into tbl_issue_detail(Issue_Category,Issue_Date,Priority,Description,Status) Values(@Issue_Category,@Issue_Date,@Priority,@Description,@Status)", conn);
        ...
        public ActionResult IssueDetails()
        {
            ...
            using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(Connection))
            {
                MySql.Data.MySqlClient.MySqlDataAdapter da = new MySql.Data.MySqlClient.MySqlDataAdapter("SELECT I.*,R.FirstName AS EngineerName FROM tbl_issue_detail I Left Join tbl_user_registration R ON I.Engin_Id = R.UserID Order By Issue_Date", conn);
                da.Fill(ds);
        ...
        public ActionResult Cancle(string ID)
        {
            ...
            using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(Connection))
            {
                MySql.Data.MySqlClient.MySqlCommand cmd1 = new MySql.Data.MySqlClient.MySqlCommand("Update tbl_issue_detail set Status = 'Cancle' Where ID=@ID", conn);
        ...
        [HttpPost]
        public ActionResult Solution(IssueDetail obj)
        {
            //string status = "";
            string ID = "";
            int count = 0;
        ...
        [HttpPost]
        public ActionResult Feedback(IssueDetail IssueDetail)
        {
            int count = 0;
            string Out = "";
            string ID = "";
